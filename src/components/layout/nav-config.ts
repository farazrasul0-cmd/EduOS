...
export const NAV: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'students', labelKey: 'nav.students', icon: Users, path: '/students', count: 142, roles: ['owner', 'admin', 'teacher'] },
      ...
      { id: 'assignments', labelKey: 'nav.assignments', icon: FileText, path: '/assignments', count: 3, roles: ['owner', 'admin', 'teacher', 'parent', 'student'] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'fees', labelKey: 'nav.fees', icon: Banknote, path: '/fees', count: 12, roles: ['owner', 'admin', 'parent', 'student'] },
